            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between border border-slate-100">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <Button
                        ...
                        className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-3 rounded-2xl shadow-sm transition-all duration-200 cursor-pointer"
                    >
                        <Plus size={20} />
                        Registrar Pesaje
                    </Button>
                    ...
                    <div className="bg-white w-full max-w-md p-8 rounded-3xl shadow-2xl relative border border-slate-100">
                        <form onSubmit={handleAddWeight} className="space-y-5">
                            <button 
                                ...
                                className="absolute top-6 right-6 text-slate-400 hover:text-slate-700 font-bold cursor-pointer"
                            >
                                ✕
                            </button>
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                <button 
                                    type="button"
                                    onClick={() => setIsModalOpen(false)}
                                    className="px-5 py-2.5 rounded-xl font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 transition-colors cursor-pointer text-sm"
                                >
                                    Cancelar
                                </button>
                                <button 
                                    type="submit"
                                    className="px-5 py-2.5 rounded-xl font-bold text-white bg-emerald-600 hover:bg-emerald-700 transition-colors shadow-sm cursor-pointer text-sm"
                                >
                                    Guardar Peso
                                </button>
                            </div>
